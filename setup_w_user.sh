...
if [ $(command -v curl) ] && [ $(command -v sudo) ]; then
    source <(curl -sSL https://raw.githubusercontent.com/pirafrank/workspace/main/workspace_versions.sh)
    curl -sSL https://raw.githubusercontent.com/pirafrank/workspace/main/setup.sh | sudo -H -u $newuser bash
else
